...
public class CreatePlayerAdapter extends RecyclerView.Adapter<CreatePlayerAdapter.ViewHolder> {
    ...
    public CreatePlayerAdapter(List<Player> players) {
        mPlayers = players;
    }

    @Override
    public CreatePlayerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(CreatePlayerAdapter.ViewHolder viewHolder, final int position) {
